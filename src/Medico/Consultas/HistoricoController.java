...
public class HistoricoController implements Initializable {
    ...
    String estados[]={"", "Completa", "Pendente"}, formas[]={"c.especialidade", "localizacao", "concat(p.nome,' ',p.sobrenome)"};
    ...
    void marcarCons(ActionEvent event) throws IOException {
        new ScreenController().mudaBorderDireita("/Medico/Consultas/Organizar.fxml");
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        TableColumn colunas[]={new TableColumn("Paciente"), new TableColumn("Especialidade"), new TableColumn("Local"),
        ...
        ObservableList<String> lista=FXCollections.observableArrayList("Especialidade", "Local", "Paciente");
